/**
 * /grade — agent grading page. Enter an agent handle or URL; the
...
export const metadata: Metadata = {
  ...
  description:
    "Score any agentic AI app across acceleration, traction, credibility, and niche position. Get an instant scorecard, then build the better version in Agent Studio.",
  ...
  openGraph: {
    ...
    description:
      "Score any agentic AI app across acceleration, traction, credibility, and niche position. Get an instant scorecard.",
  },
  twitter: {
      ...
      <main id="main-content" className="lp-shell lp-page">
        <header className="lp-page-head">
          ...
          <p className="lp-lede">
            ...
            tells you where it stands. Then build the agent that fixes what it
            found.
          </p>
          <div className="grade-caps" aria-label="What you can do on this page">
            ...
            <span>weakest pillar identified</span>
